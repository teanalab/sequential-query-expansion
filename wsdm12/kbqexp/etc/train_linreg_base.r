...
attach(train_data);
log_reg<-glm(map~numQryTerms+topDocScore+expTDocScore+topTermFrac+numCanDocs+avgCDocScore+maxCDocScore+idf+spActScore+spActRank+avgColCor+maxColCor+avgTopCor+maxTopCor+avgTopPCor+maxTopPCor);
log_reg